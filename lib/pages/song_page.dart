...
import 'package:player/controller/song_data_controller.dart';
import 'package:player/controller/song_player_controller.dart';
                          ...
                          children: songDataController.localSongList.value
                              .map(
                                (e) => SongTile(
                                  songName: e.title,
                                  onPress: () {
                                    songPlayerController.playLocalSong(e.data);
                                  },
                                ),
                              )
                              .toList(),
